/**
 * ═══════════════════════════════════════════════════════════════════════════
 *  IMPRESSUM PAGE | OeH Wirtschaft Website
 * ═══════════════════════════════════════════════════════════════════════════
 *
 *  BESCHREIBUNG:
 *  Rechtliche Informationen und Impressum der Website.
 *
 * ───────────────────────────────────────────────────────────────────────────
...
export default function Impressum() {
  ...
  return (
    <motion.div variants={pv} initial="initial" animate="animate" exit="exit">
      {/* Hero Sektion */}
      <section data-testid="impressum-hero" className="relative pt-28 pb-16 md:pt-36 md:pb-20 px-5 overflow-hidden">
        ...
        <div className="max-w-[800px] mx-auto relative">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, duration: 0.6 }}
            ...
            <span className="text-sm text-slate-500 font-medium">{t('impressum.section')}</span>
          </motion.div>
      ...
      {/* Impressum Content */}
      <section data-testid="impressum-content" className="py-12 px-5">
                ...
                <div className="space-y-4 text-slate-600 leading-relaxed">
                  ...
                  <div className="pt-4 border-t border-slate-100">
                    ...
                    <a
                      ...
                      data-testid="impressum-oeh-link"
                      className="inline-flex items-center gap-2 mt-3 text-blue-500 hover:text-blue-600 font-medium transition-colors"
                    >
